try:
    ...
    class ExecVars:
        ...
        API_HASH = "295d449480357269a6f7d74b83fff771"
        API_ID = 2898344
        BOT_TOKEN = "1628431160:AAEPKetrpUyXxWAufx_vim4KNCE3B4NX5mM"
        BASE_URL_OF_BOT = "https://tortool323.herokuapp.com"

        # Edit the server port if you want to keep it default though.
        SERVPORT = 80

        # ALLOWED USERS [ids of user or supergroup] seperate by commas
        ALD_USR = [-1001267728460,885488992]
